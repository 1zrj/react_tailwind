...
function Hero() {
    return (
        <div className='grid justify-items-center gap-8 relative'>
            <p className='text-4xl md:text-4xl font-black text-center leading-normal md:leading-normal'>
                打造一个完美的、现象级的、充满创造力的网页
            </p>
            <p className='text-xl text-gray-700 md:w-1/2 text-center'>
                这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具
            </p>
            <div>
